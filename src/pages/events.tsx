...
const regularEvents = [
  { day: 'Sunday', time: '10:00 AM', name: 'Sunday School', desc: 'Bible study classes for all ages.', icon: 'fa-bible', color: 'blue' },
  { day: 'Sunday', time: '11:15 AM', name: 'Sunday Worship Service', desc: 'Main worship service featuring praise and expository preaching.', icon: 'fa-church', color: 'gold' },
  { day: 'Wednesday', time: '6:30 PM', name: 'Prayer & Bible Study', desc: 'Midweek gathering for prayer, worship, and study of Scripture.', icon: 'fa-pray', color: 'purple' },
  { day: 'Thursday', time: '7:00 PM', name: 'Choir Rehearsal', desc: 'Music Ministry rehearsal open to all who sing or play.', icon: 'fa-music', color: 'amber' },
  { day: '1st Saturday', time: '8:00 AM', name: "Men's Ministry Breakfast", desc: 'Monthly fellowship, accountability, and study for men.', icon: 'fa-shield-alt', color: 'green' },
  { day: '2nd Saturday', time: '10:00 AM', name: "Women's Ministry Gathering", desc: 'Monthly Bible study, fellowship, and service for women.', icon: 'fa-heart', color: 'rose' },
]
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-20">
          <div class="text-center mb-12 fade-in">
            ...
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-brand-navy mb-3">Weekly Schedule</h2>
              ...
              <div key={i} class={`event-card bg-white rounded-2xl px-6 py-5 shadow-sm fade-in delay-${(i % 3) + 1}`}>
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                  <div class="flex items-center gap-4 flex-1">
                    <div class="w-12 h-12 bg-brand-navy rounded-xl flex items-center justify-center flex-shrink-0">
                      <i class={`fas ${ev.icon} text-brand-gold`}></i>
                    </div>
                    <div>
                      <h3 class="font-serif font-bold text-brand-navy text-lg">{ev.name}</h3>
                  ...
                  <div class="flex items-center gap-3 sm:flex-col sm:items-end text-right">
                    ...
                    <span class="text-brand-navy font-semibold text-sm">{ev.time}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div class="mb-16 fade-in">
          <div class="text-center mb-10">
            <h2 class="font-serif text-3xl font-bold text-brand-navy mb-3">Upcoming Special Events</h2>
          ...
          <div class="bg-white rounded-3xl p-12 text-center shadow-md border border-brand-gold/20">
            ...
            <h3 class="font-serif text-2xl font-bold text-brand-navy mb-3">Stay Tuned</h3>
