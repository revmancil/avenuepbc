    ...
    <section class="py-24 bg-brand-cream">
      <div class="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          {[
            ...
            <div key={i} class={`bg-white rounded-2xl p-6 shadow-md card-hover fade-in delay-${(i % 3) + 1}`}>
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  <h3 class="font-serif font-bold text-brand-navy text-xl mb-2">{b.title}</h3>
        ...
        <div class="mt-16 text-center fade-in">
          ...
          <a href="/contact" class="inline-flex items-center gap-2 bg-brand-navy hover:bg-brand-dark text-white font-semibold px-8 py-4 rounded-full transition-colors shadow-lg">
